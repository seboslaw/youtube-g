Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "TODO.txt", "lib/youtube_g.rb", "lib/youtube_g/chain_io.rb", "lib/youtube_g/client.rb", "lib/youtube_g/transport.rb", "lib/youtube_g/model/author.rb", "lib/youtube_g/model/category.rb", "lib/youtube_g/model/contact.rb", "lib/youtube_g/model/content.rb", "lib/youtube_g/model/playlist.rb", "lib/youtube_g/model/rating.rb", "lib/youtube_g/model/thumbnail.rb", "lib/youtube_g/model/user.rb", "lib/youtube_g/model/video.rb", "lib/youtube_g/parser.rb", "lib/youtube_g/record.rb", "lib/youtube_g/request/base_search.rb", "lib/youtube_g/request/standard_search.rb", "lib/youtube_g/request/user_search.rb", "lib/youtube_g/request/video_search.rb", "lib/youtube_g/request/video_upload.rb", "lib/youtube_g/response/video_search.rb", "lib/youtube_g/response/error.rb", "lib/youtube_g/version.rb", "test/helper.rb", "test/test_chain_io.rb", "test/test_client.rb", "test/test_video.rb", "test/test_video_search.rb", "test/test_transport.rb", "test/test_errors.rb"]
  s.has_rdoc = true
